...
SCSocket.prototype._emit = function (event, data) {
  var self = this;
  ...
  return new Promise(function(resolve,reject) {
    ...
    self._emitBuffer.append(eventNode);
...
SCSocket.prototype.emit = function (event, data, callback) {
  if (this._localEvents[event] != null) return Emitter.prototype.emit.call(this, event, data)
